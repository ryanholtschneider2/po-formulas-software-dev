...
def minimal_task(
    ...
    agent_step(
        ...
        seed_id=issue_id, rig_path=str(rig_path_p),
        step="triage", iter_n=1,
    ...
    for iter_n in range(1, iter_cap + 1):
        ...
        agent_step(
            ...
            seed_id=issue_id, rig_path=str(rig_path_p),
            step="build", iter_n=iter_n,
            ctx={"iter": iter_n, "revision_note": revision_note,
