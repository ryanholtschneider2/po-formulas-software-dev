...
5. **Buildability** — each child's description is self-contained: a worker seeing only that bead has what it needs (concrete files/patterns + explicit acceptance criteria). Flag vague children.
